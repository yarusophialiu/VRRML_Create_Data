...
if __name__ == '__main__':
    ...
    base_directory = r'C:\Users\15142\Projects\VRR\Data\VRR_Patches\HPC\cleaned_patches'
    base_directory = r'D:\VRR_data\VRRML\ML\validation_label' # test, val 225000
    base_directory = r'D:\VRR_data\VRR_Patches\2024-09-20' # 12420 per scene
    base_directory = r'D:\VRR_data\VRRML\ML\reference128x128\test' 
    # base_directory = r'D:\VRR_data\VRR_Patches\reference\train' # train 402435 val 49668 test 44697
    # patch 128x128 val 321953 val 39731 test 35756, cause we only have 8 scenes
    for scene in scene_arr:
